...
```
sudo ln -s /Library/Frameworks/R.framework/Versions/4.1/Resources/bin/R /usr/local/bin
sudo ln -s /Library/Frameworks/R.framework/Versions/4.1/Resources/bin/Rscript /usr/local/bin
```
