...
7z a -tzip -mx9 c:\dumpit\InVivovStat-Win.zip c:\dumpit\Silver-win\*
7z a -tzip -mx9 c:\dumpit\InVivovStat-Linux.zip c:\dumpit\Silver-linux\*
7z a -tzip -mx9 c:\dumpit\InVivovStat-OSx.zip c:\dumpit\Silver-osx\*
