...
namespace SilveR.StatsModels
{
    public class LogisticRegressionAnalysisModel : AnalysisDataModelBase
    {
        ...
        public override string GetCommandLineArguments()
        {
            ...
            arguments.Append(" " + argFormatter.GetFormattedArgument(ContinuousFactors)); //11

            arguments.Append(" " + argFormatter.GetFormattedArgument(ContinuousFactorsTransformation, false));//12
            ...
            arguments.Append(" " + argFormatter.GetFormattedArgument(TableOfOverallEffectTests)); //15
            ...
            arguments.Append(" " + argFormatter.GetFormattedArgument(AllPairwise, false)); //20

            arguments.Append(" " + argFormatter.GetFormattedArgument(ComparisonsBackToControl, false)); //21
