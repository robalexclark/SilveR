...
# build directory.
TK_BUILD_LIB_SPEC='-L/root/64bit/tk8.6.16/win -ltk86'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/root/Tcl/lib -ltk86'
...
# compiled.
TK_SRC_DIR='/root/64bit/tk8.6.16'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/root/64bit/tk8.6.16/win -ltkstub86'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/root/Tcl/lib -ltkstub86'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/root/64bit/tk8.6.16/win/libtkstub86.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/root/Tcl/lib/libtkstub86.a'
