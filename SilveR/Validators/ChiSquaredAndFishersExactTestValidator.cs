...
namespace SilveR.Validators
{
    public class ChiSquaredAndFishersExactTestValidator : ValidatorBase
    {
        ...
        public override ValidationInfo Validate()
        {
            ...
            {
                ValidationInfo.AddErrorMessage("The Response ("+ csfetVariables.Response + ") contains non-numeric data that cannot be processed. Please check the raw data and make sure the data was entered correctly.");
                return ValidationInfo;
            }
