...
namespace SilveR.Validators
{
    public class LogisticRegressionAnalysisValidator : ValidatorBase
    {
        ...
        public override ValidationInfo Validate()
        {
            ...
            if (lrVariables.Covariates != null && String.IsNullOrEmpty(lrVariables.PrimaryFactor))
            {
                ValidationInfo.AddErrorMessage("You have selected a covariate but no primary factor is selected.");
            }

            if (!String.IsNullOrEmpty(lrVariables.ComparisonsBackToControl) && String.IsNullOrEmpty(lrVariables.ControlGroup))
            {
