...
namespace SilveR.Validators
{
    public class CorrelationAnalysisValidator : ValidatorBase
    {
        ...
        public override ValidationInfo Validate()
        {
            ...
            if (!caVariables.CorrelationCoefficient && !caVariables.TestStatistic && !caVariables.PValue && !caVariables.Scatterplot && !caVariables.Matrixplot && !caVariables.ByCategoriesAndOverall)
            {
