...
#Output HTML header
HTML.title("<bf>Nested Design Analysis", HR = 1, align = "left")
...
if (randomEffect1 == "NULL") {
    messag1 <- c("Unfortunately you need two nested random factors in order to use this module.")
    print(messag1)
...
if (repList1 == "NULL" && repList2 == "NULL" && repList3 == "NULL" && repList4 == "NULL") {
    messag1 <- c("You need to define at least one list of replications of the levels of a random factor to proceed with this analysis.")
    print(messag1)
    HTML.title("</bf> ", HR = 2, align = "left")
    HTML.title(messag1, HR = 0, align = "left")
    quit()
...
if (len2 < len) {
    messag2 <- c("The levels of the lowest order random factor do not define the observations units (rows of the dataset). Please include an extra random factor that does.")
    print(messag2)
    HTML.title("</bf> ", HR = 2, align = "left")
...
add <- c("This module uses the estimated variance components from the original dataset to predict the hypothetical statistical power than can be achieved by varying the replication of the levels of the random factors in the experimental design, see Snedecor and Cochran (1989, p239).")
HTML.title("</bf> ", HR = 2, align = "left")
HTML.title(add, HR = 0, align = "left")
...
HTML.title(title, HR = 2, align = "left")
Comment <- c("The following replication of the levels of the random factors are used in the power analyses, unless alternative replications are defined by the user. They are an estimate of the replication used within the original design.")
HTML.title("</bf> ", HR = 2, align = "left")
...
if (randomEffect1 != "NULL" && randomEffect2 != "NULL" && randomEffect3 == "NULL" && randomEffect4 == "NULL" && repList1 != "NULL") {
    ...
    Comment1 <- c("These power curves assume the replication of the levels of the random factor ")
...
if (randomEffect1 != "NULL" && randomEffect2 != "NULL" && randomEffect3 == "NULL" && randomEffect4 == "NULL" && repList2 != "NULL") {
    ...
    Comment2 <- c("These power curves assume the replication of the levels of the random factor ")
...
if (randomEffect1 != "NULL" && randomEffect2 != "NULL" && randomEffect3 != "NULL" && randomEffect4 == "NULL" && repList1 != "NULL") {
    ...
    Comment1 <- paste(Comment1, " and the replication of the levels of the random factor ", sep = "")
...
if (randomEffect1 != "NULL" && randomEffect2 != "NULL" && randomEffect3 != "NULL" && randomEffect4 != "NULL" && repList1 != "NULL") {
    ...
    Comment1 <- paste(Comment1, " is ", sep = "")
    Comment1 <- paste(Comment1, rep2, sep = "")
    Comment1 <- paste(Comment1, ", the replication of the levels of the random factor ", sep = "")
    Comment1 <- paste(Comment1, randomEffect3, sep = "")
    Comment1 <- paste(Comment1, " is ", sep = "")
...
if (randomEffect1 != "NULL" && randomEffect2 != "NULL" && randomEffect3 != "NULL" && randomEffect4 != "NULL" && repList2 != "NULL") {
    ...
    Comment2 <- paste(Comment2, " is ", sep = "")
    Comment2 <- paste(Comment2, rep1, sep = "")
    Comment2 <- paste(Comment2, ", the replication of the levels of the random factor ", sep = "")
    Comment2 <- paste(Comment2, randomEffect3, sep = "")
    Comment2 <- paste(Comment2, " is ", sep = "")
