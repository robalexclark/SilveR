...
#===================================================================================================================
	...
	if(Weight == "1/Response") {
	  add<-paste(c("The analysis performed is a weighted non-linear regression, using 1/Response as the weighting.",sep=""))
	}
	if(Weight == "1/Response^2") {
	  add<-paste(c("The analysis performed is a weighted non-linear regression, using 1/Response^2 as the weighting.",sep=""))
	}
	HTML(add, align="left")
