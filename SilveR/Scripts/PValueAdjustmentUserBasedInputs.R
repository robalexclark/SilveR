...
#===================================================================================================================
if (testtype == "UseDataSet") {
	HTML("If the input dataset has been generated by either the Single Measures Parametric Analysis module or Repeated Measures Parametric Analysis module, you should confirm the correct set of p-values have been uploaded.", align="left")
