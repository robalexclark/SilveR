...
#===================================================================================================
#Simons means comparison function
...
#Output HTML header
HTML.title("<bf>Means Comparison", HR = 1, align = "left")

HTML.title("<bf> ", HR = 2, align = "left")
HTML.title("Power calculations made assume the statistical analysis will be performed using the two sample t-test. 
...
powercurvesactual <- function(standev, diffs) {
    ...
    #HTML(sample, classfirstline="second", align="left")
