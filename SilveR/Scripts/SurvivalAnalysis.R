...
if (UpdateIVS == "Y") {
	...
	HTML(paste(capture.output(print(citation("survival"),bibtex=F))[2], capture.output(print(citation("survival"),bibtex=F))[3], sep = ""),  align="left")
	HTML(paste(capture.output(print(citation("gridExtra"),bibtex=F))[4], capture.output(print(citation("gridExtra"),bibtex=F))[5], capture.output(print(citation("gridExtra"),bibtex=F))[6], sep = ""),  align="left")
}
