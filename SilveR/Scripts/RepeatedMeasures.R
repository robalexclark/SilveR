...
#-------------------------------------------------------------------------------------------------
#Output HTML header
HTML.title("<bf>Repeated Measures Parametric Analysis", HR = 1, align = "left")
...
add <- c("A full description of mixed model theory, including information on the R nlme package used, can be found in Venables and Ripley (2003) and Pinherio and Bates (2002).")
HTML.title("</bf> ", HR = 2, align = "left")
HTML.title(add, HR = 0, align = "left")
...
if (showdataset == "Y") {
    ...
    HTML(statdata_temp2, classfirstline = "second", align = "left")
}
