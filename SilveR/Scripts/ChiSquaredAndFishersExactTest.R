...
#Warning
HTML.title("Note, this module should be used to analyse count data that can be expressed in the form of a contingency table. These tests assess the significance of the association (contingency) between the two treatment classifications.", align="left")
...
HTML(fishdata, classfirstline="second", align="left", row.names = "FALSE")
...
if (BarnardsExactTest == "Y") {
	...
	if (row ==2 && col == 2) {
		...
		if (BarnardsHypothesis != "Two-sided")	{
			HTML("The test result presented is the one-sided p-value for the Bernard's test. ", align="left")
		}
