...
if(repList1=="NULL" && repList2 =="NULL" && repList3 =="NULL" && repList4 =="NULL" ) {
	HTML("You need to define at least one list of replications of the levels of a random factor to proceed with this analysis.", align="left")
	quit()
} 
...
if (randomEffect1 != "NULL" && randomEffect2 != "NULL" && randomEffect3 == "NULL" && randomEffect4 == "NULL" && repList1!="NULL") {
	...
	png(plot1,width = jpegwidth, height = jpegheight, units="in", res=PlotResolution)
...
if (randomEffect1 != "NULL" && randomEffect2 != "NULL" && randomEffect3 == "NULL" && randomEffect4 == "NULL" && repList2!="NULL") {
	...
	png(plot2,width = jpegwidth, height = jpegheight, units="in", res=PlotResolution)
...
if (randomEffect1 != "NULL" && randomEffect2 != "NULL" && randomEffect3 == "NULL" && randomEffect4 == "NULL" && repList1!="NULL" && repList2!="NULL") {
	...
	if (l1 ==l2) {
		...
		png(plot12,width = jpegwidth, height = jpegheight, units="in", res=PlotResolution)
...
if (randomEffect1 != "NULL" && randomEffect2 != "NULL" && randomEffect3 != "NULL" && randomEffect4 == "NULL" && repList3!="NULL") {
	...
	png(plot3,width = jpegwidth, height = jpegheight, units="in", res=PlotResolution)
...
if (randomEffect1 != "NULL" && randomEffect2 != "NULL" && randomEffect3 != "NULL" && randomEffect4 != "NULL" && repList4!="NULL") {
	...
	png(plot4,width = jpegwidth, height = jpegheight, units="in", res=PlotResolution)
...
if (UpdateIVS == "Y") {
	...
	HTML(paste(capture.output(print(citation("nlme"),bibtex=F))[4], capture.output(print(citation("nlme"),bibtex=F))[5], capture.output(print(citation("nlme"),bibtex=F))[6], sep = ""),  align="left")
}
...
if (OutputAnalysisOps == "Y") {
	...
	if (treatments != "NULL") {
		HTML(paste("Treatment factor(s): ", treatments, sep=""), align="left")
	}

	if (otherFactors != "NULL") {
		HTML(paste("Other design (block) factor(s): ", otherFactors, sep=""), align="left")
	}
	...
	if (repList1 != "NULL" && randomEffect1 != "NULL") {
		HTML(paste("Replication of levels of random factor 1: ", repList1, sep=""), align="left")
	}

	if (repList2 != "NULL" && randomEffect2 != "NULL") {
		HTML(paste("Replication of levels of random factor 2: ", repList2, sep=""), align="left")
	}

	if (repList3 != "NULL" && randomEffect3 != "NULL") {
		HTML(paste("Replication of levels of random factor 3: ", repList3, sep=""), align="left")
	}

	if (repList4 != "NULL" && randomEffect4 != "NULL") {
		HTML(paste("Replication of levels of random factor 4: ", repList4, sep=""), align="left")
	}
}