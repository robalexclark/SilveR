...
namespace Silver.UnitTests.StatsModels
{
    ...
    public class MeansComparisonUserBasedInputsModelTests
    {
        [Fact]
        public void ScriptFileName_ReturnsCorrectString()
        {
            //Arrange
            MeansComparisonUserBasedInputsModel sut = new MeansComparisonUserBasedInputsModel();

            //Act
            string result = sut.ScriptFileName;

            //Assert
            Assert.Equal("MeansComparisonUserBasedInputs", result);
        }
        ...
        {
            //Arrange
            MeansComparisonUserBasedInputsModel sut = GetModel();
        ...
        private MeansComparisonUserBasedInputsModel GetModel()
        {
            var model = new SilveR.StatsModels.MeansComparisonUserBasedInputsModel
            {
                AbsoluteChange = "5",
