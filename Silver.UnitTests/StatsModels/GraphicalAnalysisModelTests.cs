...
namespace SilveR.UnitTests.StatsModels
{
    public class GraphicalAnalysisModelTests
    {
        ...
        public void GetArguments_ReturnsCorrectArguments()
        {
            ...
            var xAxisLevelsOrder = result.Single(x => x.Name == "XAxisLevelsOrder");
            Assert.Equal("T3,T1", xAxisLevelsOrder.Value);

            var firstCatFactorLevelsOrder = result.Single(x => x.Name == "FirstCatFactorLevelsOrder");
            Assert.Equal("T1", firstCatFactorLevelsOrder.Value);
        }
        ...
        public void LoadArguments_ReturnsCorrectArguments()
        {
            ...
            arguments.Add(new Argument { Name = "XAxisMin" });
            arguments.Add(new Argument { Name = "XAxisMax" });
            arguments.Add(new Argument { Name = "YAxisMin" });
            arguments.Add(new Argument { Name = "YAxisMax" });

            Assert.Equal(33, arguments.Count);
            ...
            Assert.Null(sut.XAxisMin);
            Assert.Null(sut.XAxisMax);
            Assert.Null(sut.YAxisMin);
            Assert.Null(sut.YAxisMax);
        }
        ...
        public void GetCommandLineArguments_ReturnsCorrectString()
        {
            ...
            //Assert
            Assert.Equal("Treatment None Respivs_sp_ivs1 None Cat1 Cat2 Overlaid \"The Title\" \"The x axis\" \"The y axis\" T3,T1 T1 NULL Y N N N Outliers Y Column SEM Y N Y Treativs_sp_ivs1 N 5 N N NULL NULL NULL NULL", result);
        }
        ...
        private GraphicalAnalysisModel GetModel(IDataset dataset)
        {
            var model = new SilveR.StatsModels.GraphicalAnalysisModel(dataset)
            {
                ...
                XAxisLevelsOrder = "T3, T1  ",
                FirstCatFactorLevelsOrder = " T1",
                SecondCatFactorLevelsOrder = null
            };
