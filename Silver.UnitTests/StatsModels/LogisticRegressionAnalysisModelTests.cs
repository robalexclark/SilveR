...
{
    public class LogisticRegressionAnalysisModelTests
    {
        [Fact]
        public void ScriptFileName_ReturnsCorrectString()
        {
            ...
            LogisticRegressionAnalysisModel sut = new LogisticRegressionAnalysisModel();

            //Act
            string result = sut.ScriptFileName;

            //Assert
            Assert.Equal("LogisticRegressionAnalysis", result);
        }
        ...
        public void ExportData_ReturnsCorrectStringArray()
        {
            ...
            LogisticRegressionAnalysisModel sut = GetModel(mockDataset.Object);
            sut.Treatments = new List<string>() { "Treat1" };
            sut.ContinuousFactors = new List<string>() { "Cont1" };
        ...
        public void GetArguments_ReturnsCorrectArguments()
        {
            ...
            var prPlotSelected = result.Single(x => x.Name == "TableOfOverallEffectTests");
        ...
        public void LoadArguments_ReturnsCorrectArguments()
        {
            //Arrange
            System.Threading.Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
            LogisticRegressionAnalysisModel sut = new LogisticRegressionAnalysisModel(GetDataset());
            ...
            arguments.Add(new Argument { Name = "TableOfOverallEffectTests", Value = "True" });
            ...
            Assert.True(sut.TableOfOverallEffectTests);
        ...
        public void GetCommandLineArguments_ReturnsCorrectString()
        {
            ...
            Assert.Equal("Respivs_sp_ivs1~Covivs_sp_ivs1+Block3+Treat1+Treat2+Treat1*Treat2 Respivs_sp_ivs1~scatterPlotColumn Covivs_sp_ivs1 None None Treat1 Treat1,Treat2 Cont1 None Block3 Y Y 0.05 Respivs_sp_ivs1~Covivs_sp_ivs1+Block3+mainEffect Treat1ivs_sp_ivs*ivs_sp_ivsTreat2 N Tukey Holm D1 Y", result);
        }

        private LogisticRegressionAnalysisModel GetModel(IDataset dataset)
        {
            var model = new LogisticRegressionAnalysisModel(dataset)
            {
                ANOVASelected = true,
                AllPairwise = "Tukey",
                ...
                TableOfOverallEffectTests = true,
